...
BEGIN
    ...
    VALUES (NOW(), 'INSERT', NEW.READER_ID, NEW.FIRSTNAME,
...
BEGIN
    ...
    VALUES (NOW(), 'INSERT', NEW.BOOK_ID, NEW.TITLE, NEW.PUBYEAR,
            NEW.BESTSELLER);
END $$
...
BEGIN
    ...
    VALUES (NOW(), 'DELETE', OLD.READER_ID, OLD.FIRSTNAME,
            OLD.LASTNAME, OLD.PESELID, OLD.VIP_LEVEL);
END $$
...
BEGIN
    ...
    VALUES (NOW(), 'DELETE', OLD.BOOK_ID, OLD.TITLE, OLD.PUBYEAR,
            OLD.BESTSELLER);
END $$
...
BEGIN
    ...
    VALUES (NOW(), 'UPDATE', OLD.READER_ID, OLD.FIRSTNAME,
            OLD.LASTNAME, OLD.PESELID, OLD.VIP_LEVEL,
